...
public class CartOrderSteps {
    ...
    // ── Background helper: add a product to the cart ────────
    ...
    public void confirmationShouldShowTotal(String expectedTotal) {
        ...
        // Strip the dollar sign for comparison — the body contains "Amount: 400 USD"
        String numericExpected = expectedTotal.replace("$", "");
        Assert.assertTrue(body.contains(numericExpected),
                "Expected total '" + numericExpected + "' in confirmation but got: " + body);
